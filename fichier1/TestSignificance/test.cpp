 ...
 for(double i=0.1; i<1;i+=0.1)
    {
      ...
      fichier3<<"----------------------------------------------------"<<endl;
      fichier3<<"uncert_bkg	 lnN 	1	 1.2 	"<<endl;
      fichier3.close();

      ofstream fichier4("500_50.tab");
      ...
      fichier4<<"----------------------------------------------------"<<endl;
      fichier4<<"uncert_bkg	 lnN 	1	 1.2 	"<<endl;
      fichier4.close();
      
      system("sh combineCommands.sh >> essaie.txt");
      system("sh combineCommands1.sh >> essaie1.txt");
      system("sh combineCommands2.sh >> essaie2.txt");
      ifstream fichier("essaie.txt");
      ifstream fichier5("essaie1.txt");
      ifstream fichier6("essaie2.txt");
      int x=0;
      int y=0;
      int z=0;
			  ...
			  if(x==3 && y==3 && z==3)
			    {
			      ...
			      fichier2<<i<<" "<<Zbi(2,i,0.2)<<" "<<val_neutr<<" "<<Zbi(5,i,0.2)<<" "<<val_neutr1<<" "<<Zbi(10,i,0.2)<<" "<<val_neutr2<<endl;  // on l'affiche
			    }
			}
		    }
		}
