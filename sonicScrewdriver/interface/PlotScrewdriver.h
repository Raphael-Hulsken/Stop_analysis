...
namespace theDoctor
{
    ...
    class PlotScrewdriver
    {
        ...
        {
          //  cout<<"tracer plots"<<endl;
	  // DEBUG_MSG << "Producing plot type " << endl;
		...
		//	cout<<dependencies[i].first<<endl;
	      }
	    ...
	    // cout<<scheduledPlots[0].first<<endl;
                ...
                string options = "")
        {
            ...
            for (unsigned int i = 0 ; i < scheduledPlots.size() ; i++)
            {
                ...
                if (plotType == "1DStack")
		  {// cout<<"1DStackkkkkk"<<endl;
                    inputFromProducer =		      Plot1DStack           ::Produce(theVariables, theProcessClasses, theRegions, theChannels, theHistoScrewdriver, theGlobalOptions, plotOptions);}
                else if (plotType == "1DSuperimposed")
                    inputFromProducer =                        Plot1DSuperimposed    ::Produce(theVariables, theProcessClasses, theRegions, theChannels, theHistoScrewdriver, theGlobalOptions, plotOptions);
                else if (plotType == "1DSuperimposedNoNorm")
                    inputFromProducer =                        Plot1DSuperimposedNoNorm    ::Produce(theVariables, theProcessClasses, theRegions, theChannels, theHistoScrewdriver, theGlobalOptions, plotOptions);
                else if (plotType == "1DFigureOfMerit")
                    inputFromProducer =                        Plot1DFigureOfMerit   ::Produce(theVariables, theProcessClasses, theRegions, theChannels, theHistoScrewdriver, theGlobalOptions, plotOptions);
                else if (plotType == "1DDataMCComparison")
                    inputFromProducer =                        Plot1DDataMCComparison::Produce(theVariables, theProcessClasses, theRegions, theChannels, theHistoScrewdriver, theGlobalOptions, plotOptions);
                else if (plotType == "2D")
                    inputFromProducer =                        Plot2D                ::Produce(theVariables, theProcessClasses, theRegions, theChannels, theHistoScrewdriver, theGlobalOptions, plotOptions);
                else if (plotType == "2DSuperimposed")
                    inputFromProducer =                        Plot2DSuperimposed    ::Produce(theVariables, theProcessClasses, theRegions, theChannels, theHistoScrewdriver, theGlobalOptions, plotOptions);
                else if (plotType == "1DFrom2DProjection")
                    inputFromProducer =                        Plot1DFrom2DProjection::Produce(theVariables, theProcessClasses, theRegions, theChannels, theHistoScrewdriver, theGlobalOptions, plotOptions);
                else if (plotType == "2DFrom3DProjection")
                    inputFromProducer =                        Plot2DFrom3DProjection::Produce(theVariables, theProcessClasses, theRegions, theChannels, theHistoScrewdriver, theGlobalOptions, plotOptions);
                else if (plotType == "1DDataMCComparisonFigure")
                    inputFromProducer =                        Plot1DDataMCComparisonFigure::Produce(theFiguresPerProcessMap, theProcessClasses, theRegions, theChannels, theGlobalOptions, plotOptions);
                else if (plotType == "1DFigure")
                    inputFromProducer =                        Plot1DFigure               ::Produce(theFiguresMap,                               theRegions, theChannels, theGlobalOptions, plotOptions);
	
		//	cout<< inputFromProducer.size() <<end;
